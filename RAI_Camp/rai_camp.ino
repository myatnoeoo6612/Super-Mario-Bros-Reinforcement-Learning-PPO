...
void loop() {
  ...
  if ( far_left == 1 && left == 1 && center == 0 && right == 1 && far_right == 1) //00100
  {
    error = 0;
  }

  else if ( far_left == 1 && left == 0 && center == 0 && right == 1 && far_right == 1) //01100
  {
    error = 1;
  }

  else if ( far_left == 1 && left == 1 && center == 0 && right == 0 && far_right == 1) //00110
  {
    error = -1;
  }

  else if ( far_left == 1 && left == 0 && center == 1 && right == 1 && far_right == 1) //01000
  {
    error = 2;
  }

  else if ( far_left == 1 && left == 1 && center == 1 && right == 0 && far_right == 1) //00010
  {
    error = -2;
  }

  else if ( far_left == 0 && left == 0 && center == 1 && right == 1 && far_right == 1) //11000
  {
    error = 3;
  }

  else if ( far_left == 1 && left == 1 && center == 1 && right == 0 && far_right == 0) //00011
  {
    error = -3;
  }

  else if ( far_left == 0 && left == 1 && center == 1 && right == 1 && far_right == 1) //10000
  {
    error = 100;
  }

  else if ( far_left == 1 && left == 1 && center == 1 && right == 1 && far_right == 0) //00001
  {
    error = -100;
  }

  else if ( far_left == 0 && left == 0 && center == 0 && right == 1 && far_right == 1) //11100
  {
    error = 101;
  }

  else if ( far_left == 1 && left == 1 && center == 0 && right == 0 && far_right == 0) //00111
  {
    error = -101;
  }
